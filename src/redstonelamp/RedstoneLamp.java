...
public class RedstoneLamp {
	...
	public static void main(String[] args) {
		...
		File cache = new File(props.getProperty(PLUGIN_CLASS_FILE_FOLDER).trim()); // class files are generated in this folder
		if(!cache.exists())
			cache.mkdirs();
		...
		// loads all java plug-in files
		pluginLoader.loadJavaPlugins();
